...
const projects = [
  ...
  },
  {
    id: 5,
    title: "EchoQuotePNG",
    description: "Just for fun project to type quote and save",
    linkRepo: "https://github.com/Mudien-UB/EchoQuotePNG",
...
export default function ProjectsPage({ id }) {
  ...
  return (
    <section
      ...
      <h2 className="text-3xl font-montserrat font-semibold text-center mt-20 mb-6">
        Recent Projects Repo
      </h2>
