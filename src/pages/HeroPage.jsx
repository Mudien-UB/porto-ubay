...
export default function HeroPage({ id }) {
  ...
  return (
    <section id={id} className="w-11/12 mx-auto h-screen flex flex-col items-center justify-center text-center">
      ...
      <button
        onClick={downloadCv}
        className="mt-6 px-6 py-3 bg-gold-500 text-green-900 font-bold rounded-xl shadow-lg border-3 border-gold-400 hover:bg-golden-brown-600 hover:border-golden-brown-600 transition-all duration-300"
      >
        Get My CV
      </button>
    </section>
